// ------------------------------------------------------------------------------------------------------
// <copyright file="FantomTransactionIntervalData.cs" company="Nomis">
...
namespace Nomis.Ftmscan.Interfaces.Models
{
    ...
    public class FantomTransactionIntervalData :
        ITransactionIntervalData
    {
        ...
        public decimal AmountSumValue => AmountSum.ToFtm();
        ...
        public decimal AmountOutSumValue => AmountOutSum.ToFtm();
        ...
        public decimal AmountInSumValue => AmountInSum.ToFtm();
