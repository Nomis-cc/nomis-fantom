// ------------------------------------------------------------------------------------------------------
// <copyright file="IWalletChainanalysisStatsCalculators.cs" company="Nomis">
...
namespace Nomis.Chainanalysis.Interfaces.Calculators
{
    ...
    /// </summary>
    public interface IWalletChainanalysisStatsCalculators<TWalletStats, TTransactionIntervalData> :
